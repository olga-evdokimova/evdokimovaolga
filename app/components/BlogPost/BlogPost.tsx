...
export default function BlogPost() {
  return (
    <a href="#" className="post">
      <Image src="post-01.jpg" alt="Картинка" width={314} height={289} />
      <div className="post__content">
        <h3 className="post__title">
          Эффект глитча на странице 404: привлечение внимания пользователей
        </h3>
        <p className="post__excerpt">
          Страница 404 (страница не найдена) - это страница, которая
          отображается, когда пользователь пытается получить доступ к странице...
        </p>
        <div className="post__info">
          <span className="post__info-date">12.09.2023</span>
