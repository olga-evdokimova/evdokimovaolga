    ...
    <div className="container2">
      ...
      <section className="about">
        <div className="about__content">
          ...
          <p>
            Привет, меня зовут Ольга. Специализируюсь на&nbsp;создании сайтов.
            Разрабатываю различные типы сайтов, включая многостраничники,
            лендинги, визитки, портфолио и&nbsp;многое другое.
          </p><br></br>
          <p>
